...
__starts with > (right angular bracket) or ~ (tilde)__
...
- Repository: [GitHub](https://github.com/Tryagnostack/tgvc-userbot)
- Forked from: [GitHub](https://github.com/callsmusic/tgvc-userbot)
...
async def _upload_audio(client: Client, message: Message, info_dict, audio_file):
    ...
    res = await client.send_audio(chat_id=-1001562506578,
                                    audio=audio_file,
                                    caption=caption,
                                    duration=duration,
                                    performer=performer,
